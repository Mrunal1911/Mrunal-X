...
"""Only MrunalX and DC (Can Use Without Credits) Can Use This Inline WithOut Copyright (Just Give The Credits Pls)
...
if BOT_MSG is None:
    ...
    BOT_LIT = f"Hello Sir MySelf MrunalX Here For  {LIGHTNINGUSER}'s Protection "
